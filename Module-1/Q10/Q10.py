...
print("==============================")
print("1. Customers with shorter tenure are more likely to churn.")
print("2. Month-to-month contracts generally show higher churn.")
print("3. Customers with higher monthly charges tend to leave more often.")
print("4. Long-term contracts improve customer retention.")
print("5. Retention efforts should focus on new customers.")
